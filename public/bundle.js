...
/***/ (function(module, exports, __webpack_require__) {
	...
	_reactDom2.default.render(_react2.default.createElement(_Main2.default, null), document.getElementById('fields-code'));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Code = __webpack_require__(160);

	var _Code2 = _interopRequireDefault(_Code);

	var _Inputs = __webpack_require__(161);

	var _Inputs2 = _interopRequireDefault(_Inputs);

	var _PopUpButton = __webpack_require__(162);

	var _PopUpButton2 = _interopRequireDefault(_PopUpButton);

	var _BuiltInButton = __webpack_require__(163);

	var _BuiltInButton2 = _interopRequireDefault(_BuiltInButton);
	...
	var Contacts = function (_React$Component) {
	    ...
	    function Contacts(props) {
	        ...
	        _this.sendFrameType = _this.sendFrameType.bind(_this);
	        return _this;
	    }
	    ...
	    _createClass(Contacts, [{
	        ...
	        key: "sendFrameType",
	        value: function sendFrameType(data) {
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    "div",
	                    { className: "frame-type-buttons" },
	                    _react2.default.createElement(_PopUpButton2.default, { frame_type: "set", passFrameType: this.sendFrameType }),
	                    _react2.default.createElement(_BuiltInButton2.default, { frame_type: "open", passFrameType: this.sendFrameType })
	                ),
	                _react2.default.createElement(_Inputs2.default, { handleInputChange: this.handleInputChange }),
	                _react2.default.createElement(_Code2.default, { state: this.state, api_key: this.state.api_key })
	            );
	        }
	    }]);
	    ...
	    _createClass(Code, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                "src='https://paymo.ru/paymentgate/iframe/checkout.js'></script>",
	                " ",
	                _react2.default.createElement("br", null),
	                "<script>",
	                " ",
	                _react2.default.createElement("br", null),
	                _react2.default.createElement("span", { className: "code-tab20" }),
	                "PaymoFrame.",
	                _react2.default.createElement(
	                    "span",
	                    { className: "blue-text" },
	                    this.props.state.frame
	                ),
	                "({",
	                " ",
	                _react2.default.createElement("br", null),
	                _react2.default.createElement("span", { className: "code-tab40" }),
	                "parent_id: ",
	                '"' + parentID + '"',
	                _react2.default.createElement("br", null),
	                _react2.default.createElement("span", { className: "code-tab40" }),
	                ...
	                _react2.default.createElement(
	                    "span",
	                    { className: "blue-text" },
	                    this.props.state.payment_description
	                ),
	                '",',
	                " ",
	                _react2.default.createElement("br", null),
	    ...
	    _createClass(Inputs, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement("input", { onChange: this.handleChange, className: "input1", type: "text", name: "api_key", placeholder: "e5ebc0d4-f90b-409b-874c-c729987001da" }),
	                _react2.default.createElement(
	                    "div",
	                    { className: "fields-name" },
	                    "ID \u0442\u0440\u0430\u043D\u0437\u0430\u043A\u0446\u0438\u0438:"
	                ),
	                _react2.default.createElement("input", { onChange: this.handleChange, className: "input1", type: "text", name: "transaction_id", placeholder: "123" }),
	                _react2.default.createElement(
	                    "div",
	                    { className: "fields-name" },
	                    "\u041E\u043F\u0438\u0441\u0430\u043D\u0438\u0435 \u043F\u043B\u0430\u0442\u0435\u0436\u0430:"
	                ),
	                _react2.default.createElement("input", { onChange: this.handleChange, className: "input1", type: "text", name: "payment_description", placeholder: "\u0422\u0435\u0441\u0442\u043E\u0432\u044B\u0439 \u043F\u043B\u0430\u0442\u0435\u0436" }),
	                _react2.default.createElement(
	                    "div",
	                    { className: "fields-name" },
	                    "\u0421\u0443\u043C\u043C\u0430:"
	                ),
	                _react2.default.createElement("input", { onChange: this.handleChange, className: "input1", type: "text", name: "amount", placeholder: "1000" }),
	                _react2.default.createElement(
	                    "div",
	                    { className: "fields-name" },
	                    "\u041F\u0435\u0440\u0435\u0445\u043E\u0434 \u043D\u0430 URL \u0432 \u0441\u043B\u0443\u0447\u0430\u0435 \u0443\u043F\u0435\u0448\u043D\u043E\u0433\u043E \u043F\u043B\u0430\u0442\u0435\u0436\u0430:"
	                ),
	                _react2.default.createElement("input", { onChange: this.handleChange, className: "input1", type: "text", name: "success_url", placeholder: "http://paymo.info/success.htm" }),
	                _react2.default.createElement(
	                    "div",
	                    { className: "fields-name" },
	                    "\u041F\u0435\u0440\u0435\u0445\u043E\u0434 \u043D\u0430 URL \u0432 \u0441\u043B\u0443\u0447\u0430\u0435 \u043E\u0448\u0438\u0431\u043A\u0438:"
	                ),
	                _react2.default.createElement("input", { onChange: this.handleChange, className: "input1", type: "text", name: "fail_url", placeholder: "http://paymo.info/fail.htm" }),
	                _react2.default.createElement(
	                    "div",
	                    { className: "fields-name" },
	                    "SIGNATURE:"
	                ),
	                _react2.default.createElement("input", { onChange: this.handleChange, className: "input1", type: "text", name: "signature", placeholder: "8614632903a9672ede91910c109c8011" })
	            );
	        }
	    }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var PopUpButton = function (_React$Component) {
	    ...
	    function PopUpButton(props) {
	        ...
	        _this.passFrameType = _this.passFrameType.bind(_this);
	    ...
	    _createClass(PopUpButton, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                "div",
	                { className: "pop-up-frame-button", onClick: this.passFrameType },
	                _react2.default.createElement(
	                    "div",
	                    { className: "inner-button" },
	                    _react2.default.createElement("img", { display: "inline-block", width: "32px", height: "32px", src: "../images/frame-pop-wh.svg",
	                        alt: "" }),
	                    _react2.default.createElement(
	                        "div",
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var BuiltInButton = function (_React$Component) {
	    _inherits(BuiltInButton, _React$Component);

	    function BuiltInButton(props) {
	        _classCallCheck(this, BuiltInButton);

	        var _this = _possibleConstructorReturn(this, (BuiltInButton.__proto__ || Object.getPrototypeOf(BuiltInButton)).call(this, props));
	    ...
	    _createClass(BuiltInButton, [{
	        key: "render",
	        value: function render() {
	            return _react2.default.createElement(
	                "div",
	                { className: "built-in-frame-button", onClick: this.passFrameType },
	                _react2.default.createElement(
	                    "div",
	                    { className: "inner-button" },
	                    _react2.default.createElement("img", { display: "inline-block", width: "32px", height: "32px", src: "../images/require.svg",
	                        alt: "" }),
	                    _react2.default.createElement(
	                        "div",
